                                                                                        ...
                                                                                        <>
                                                                                                <div
                                                                                                        ...
                                                                                                        <div style={{ display: "flex", gap: "8px" }}>
                                                                                                                {item.modelChanges && item.modelChanges.length > 1 && (
                                                                                                                        <div
                                                                                                                                onClick={(e) => {
                                                                                                                                        e.stopPropagation();
                                                                                                                                        const newState = { ...expandedItems, [item.id]: !expandedItems[item.id] };
                                                                                                                                ...
                                                                                                                                <span className={`codicon codicon-chevron-${expandedItems[item.id] ? "down" : "right"}`}></span>
